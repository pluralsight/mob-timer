...
class Mobbers {
  ...
  getActiveMobbers() {
    // console.log('Mobbers getActiveMobbers.')
    const active = this.mobbers.filter(m => !m.disabled)
    // console.log('Number of active mobbers: ' + active.length)
    return active
  }
  ...
  getCurrentAndNextMobbers() {
    ...
    // console.log('getCurrentAndNextMobbers Current mobber: ' + this.currentMobber)
    return {
  ...
  rotate() {
    let active = this.getActiveMobbers()
    // console.log('Mobbers rotate. \nactive:' + active.length + '\ncurrent:' + this.currentMobber)
